 ...
 *  `text` may be a getter when the content is only known at click time (设置「关于」的诊断信息). */
export function copyButton(text: string | (() => string), className: string, label = t("clipboard.copy")): HTMLButtonElement {
