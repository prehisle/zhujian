...
export const comments = defineMessages({
  ...
  "search.inputPlaceholder": { zh: "搜索随记的内容……", en: "Search your notes…" },
  ...
  "search.idleHint": { zh: "输入关键词,跨随记 / 任务 / 回收站搜索内容,连改过的旧版本一起找。", en: "Type a keyword to search across notes, tasks and trash — past versions included." },
  "search.noMatch": { zh: "没有匹配的随记", en: "No matching notes" },
  "search.noMatchDetail": { zh: "没有随记的内容包含「{q}」。", en: "No note contains “{q}”." },
