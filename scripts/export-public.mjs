...
const ALLOW = [
  ...
  // 内容 = 官网上公开挂着的隐私政策 / 隐私权利 / 用户协议(zhujian.app/privacy.html 那几页),
  // 联系邮箱早已在 readme / user-guide / site/index.html 里公开,红线扫描过零命中。
  // ⛔ 境内那份 `site-cool/` 照旧不导出(国内渠道包只在本机 `--channel-cn` 打,不走 CI)。
  "site-app/",
