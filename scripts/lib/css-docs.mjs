...
// # 为什么要单独一件
//
// 337 的对比度门禁把「桌面」当成一整份来层叠:src/*.css 全并在一起。可桌面其实是**三个
// 窗口壳**(606 起)——capture 窗(index.html)、notebook 窗(notebook.html)与看大图的
// lightbox 遮罩窗(lightbox.html),各自加载各自那批
 ...
 * ⇒ 哪天那几份进了公开白名单,**标记就过期了却没人会说**:它会在两棵树上都安静地少判一份,
